...
namespace TasteTrailApp.Presentation.MenuItem.Controllers;
...
public class MenuItemController : Controller
{
    ...
    public async Task<IActionResult> Create(MenuItemModel newMenuItem)
    {
        try
        {
    ...
    [HttpPut]
    public async Task<IActionResult> Update([FromBody] MenuItemModel newMenuItem)
    {
        try
        {
