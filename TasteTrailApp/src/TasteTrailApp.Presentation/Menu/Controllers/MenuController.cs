...
namespace TasteTrailApp.Presentation.Menu.Controllers;
...
public class MenuController : Controller
{
    ...
    [Route("[action]")]
    public async Task<IActionResult> Create(MenuModel newMenu)
    {
        try
        {
    ...
    [HttpPut]
    public async Task<IActionResult> Update([FromBody] MenuModel newMenu)
    {
        try
        {
